...
.setColor("#7289D")
.setDescription(`${kullanıcı}, ${message.author} \`${kullanıcı.voice.channel.name}\` Adlı Odaya Gelmek İstiyor,Kabul Ediyor Musun?`)
...
.setColor("0x348f36")
.setDescription(`${kullanıcı}  Odaya Gitme Teklifini Onayladı`)
